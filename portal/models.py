...
class Skill(models.Model):
    name = models.CharField(max_length=100, unique=True, null=False, blank=False, default='General Skill')
...
class Job(models.Model):
    title = models.CharField(max_length=255, null=False, blank=False, default='Untitled Job')
    ...
    location = models.CharField(max_length=255, null=False, blank=False, default='Not specified')
